...
import Camera from 'react-native-camera'; //deprecated, need to change, need to probably change takePicture method to async
                ...
                .then((file) => {
                    ...
                    .then((ifstream) => {
                        ...
                        ifstream.onEnd(() => {  
                            ...
                            RNFB.fetch('POST', 'https://videobreakdown.azure-api.net/Breakdowns/Api/Partner/Breakdowns', 
                                {
